    ...
    for seed in random_states:
        ...
        for loop in range(options.loop):
            ...
            if loop==0:
                ...
                df.to_csv(f"./outputs/{dataset}/raw_atal_{seed}_{selection_method}_result.csv",index=False)
                df_p[seed] = [permutation for permutation in permutations]
                df_p.to_csv(f"./outputs/{dataset}/permutation_atal_{seed}_{selection_method}_result.csv",index=False)
                df_m[seed] = [metric for metric in raw_metrics]
                df_m.to_csv(f"./outputs/{dataset}/metrics_atal_{seed}_{selection_method}_result.csv",index=False)
                ...
                df[seed] = [item for item in raw_results]
                df.to_csv(f"./outputs/{dataset}/raw_atal_{seed}_f{selection_method}result.csv",index=False)
                df_p[seed] = [permutation for permutation in permutations]
                df_p.to_csv(f"./outputs/{dataset}/permutation_atal_{seed}_{selection_method}_result.csv",index=False)
                df_m[seed] = [metric for metric in raw_metrics]
                df_m.to_csv(f"./outputs/{dataset}/metrics_atal_{seed}_{selection_method}_result.csv",index=False)              
